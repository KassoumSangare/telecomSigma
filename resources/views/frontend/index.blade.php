            ...
            <div class="col-lg-6">
                <div class="content-card-glass">
                    ...
                    <div class="btn-group-custom">
                        <a href="contact" class="btn btn-info btn-lg rounded-pill px-5 fw-bold shadow">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="service-content ps-lg-5">
                    ...
                    <a href="contact_commercial" class="btn btn-primary rounded-pill px-4 mt-3 shadow-sm">Contactez nous</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-lg-6">
                <div class="service-content-card p-4 p-md-5">
                    ...
                    <a href="contact_technique" class="btn btn-outline-info rounded-pill px-4 mt-3">Nous contacter</a>
                </div>
            </div>
        </div>
    </div>
